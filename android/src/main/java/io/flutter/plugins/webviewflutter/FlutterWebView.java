...
public class FlutterWebView implements PlatformView, MethodCallHandler {
  ...
  public static ActivityResultHandler activityResultHandler;
  ...
  public static class OpenFileWebChromeClient extends WebChromeClient {
    public static final int REQUEST_FILE_PICKER = 100;
    ...
    public void openFileChooser(final ValueCallback<Uri> filePathCallback) {
      ...
      activityResultHandler = new ActivityResultHandler() {
        @Override
        public boolean shouldHandleActivityResult(int requestCode, int resultCode, Intent intent) {
          if (requestCode != REQUEST_FILE_PICKER) return false;
          Log.d("OpenFileWebChromeClient", "---1");
          String result = intent == null || resultCode != Activity.RESULT_OK ? null
                  : intent.getDataString();
          if (result != null) {
            Log.d("OpenFileWebChromeClient", "---2");
            filePathCallback.onReceiveValue(Uri.parse(result));
          } else {
            Log.d("OpenFileWebChromeClient", "---3");
    ...
    public boolean onShowFileChooser(WebView webView,
      ...
      activityResultHandler = new ActivityResultHandler() {
        ...
        public boolean shouldHandleActivityResult(int requestCode, int resultCode, Intent intent) {
          ...
          if (result != null) {
            Log.d("OpenFileWebChromeClient", "---2");
            filePathCallback.onReceiveValue(new Uri[]{Uri.parse(result)});
          } else {
            Log.d("OpenFileWebChromeClient", "---3");
            filePathCallback.onReceiveValue(null);
          }
    ...
    private String getPhotoPathByLocalUri(Context context, Uri selectedImage) {
