...
- (void)onMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  ...
  }else if ([[call method] isEqualToString:@"setWebviewScrollEnabled"]) {
       [self onSetWebviewScrollEnabled:call result:result];
     }
   else {
...
- (void)onSetWebviewScrollEnabled:(FlutterMethodCall*)call result:(FlutterResult)result {
  NSNumber* scrollEnabled = call.arguments[@"scrollEnabled"];
